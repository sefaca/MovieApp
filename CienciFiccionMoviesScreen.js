...
const CienciaFiccionMoviesScreen = () => {
    const [selectedCategory, setSelectedCategory] = useState(878);
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <CarouselComponent category={878} />  
...
export default CienciaFiccionMoviesScreen;
